...
export default function ProjectsPage() {
  return (
    ...
    //   <section className="  2xl::h-[600px] flex h-[450px] flex-col items-center justify-center bg-gradient-to-t from-[#ebebeb] to-[#dadada] font-semibold text-black dark:from-darkTheme-primary dark:to-gray-800 dark:text-white sm:h-[500px]">
