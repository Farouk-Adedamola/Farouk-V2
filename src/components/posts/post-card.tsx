...
export default function PostCard({
  ...
  return (
    <Link href={`/blog/${slug}`}>
      <article className="mx-auto flex max-w-[25rem] flex-col overflow-hidden rounded-xl shadow-xl  transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl shadow-black">
