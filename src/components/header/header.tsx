...
//           }}
//         />
//         <div className="absolute inset-0 rounded-full transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-emerald-500/0 group-hover:via-emerald-500/10 group-hover:to-emerald-500/0"></div>
//         {/* Desktop Navigation */}
...
//         >
//           <Text font="figtree" size="md" weight="bold" className="gap1 flex">
//             Menu{' '}
//             <span>
//               {mobileMenuOpen ? (
